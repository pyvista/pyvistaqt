"""Pytest configuration settings for ``pyvistaqt``."""
# pylint: disable=invalid-name  # Sphinx uses variables named here (cannot make UPPER)
...
warnings.filterwarnings(
    ...
    message='Matplotlib is currently using agg, which is a non-GUI backend, so cannot'
    'show the figure.',
)
...
copyright = f'2017-{year}, The PyVista Developers'  # pylint: disable=redefined-builtin
...
html_context = {
    ...
    # Format Template: https://{{ github_host|default('github.com') }}/{{ github_user }}/{{ github_repo }}/blob/{{ github_version }}{{ conf_py_path }}{{ pagename }}{{ suffix }}  # pylint: disable=line-too-long
    'github_user': 'pyvista',
...
notfound_context = {
    ...
    '<a href="http://docs.pyvista.org/examples/index.html">examples page</a>.',
}
