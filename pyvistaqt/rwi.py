...
# coding=utf-8
"""A simple VTK widget for PyQt or PySide. See http://www.trolltech.com for Qt
documentation, http://www.riverbankcomputing.co.uk for PyQt, and
...
if PyQtImpl == 'PyQt6':
    ...
    from PyQt6.QtCore import QEvent, QObject, QSize, Qt, QTimer  # noqa: F401
    from PyQt6.QtGui import QCursor
    from PyQt6.QtWidgets import QApplication, QMainWindow, QSizePolicy, QWidget
elif PyQtImpl == 'PySide6':
    if QVTKRWIBase == 'QOpenGLWidget':
        from PySide6.QtOpenGLWidgets import QOpenGLWidget
    from PySide6.QtCore import QEvent, QObject, QSize, Qt, QTimer  # noqa: F401
    ...
    from PySide2.QtCore import QEvent, QObject, QSize, Qt, QTimer  # noqa: F401
    from PySide2.QtGui import QCursor
    from PySide2.QtWidgets import QApplication, QMainWindow, QSizePolicy, QWidget
elif PyQtImpl == 'PyQt4':
    if QVTKRWIBase == 'QGLWidget':
        from PyQt4.QtOpenGL import QGLWidget
    from PyQt4.QtCore import QEvent, QObject, QSize, Qt, QTimer  # noqa: F401
    from PyQt4.QtGui import QApplication, QMainWindow, QSizePolicy, QWidget
elif PyQtImpl == 'PySide':
    if QVTKRWIBase == 'QGLWidget':
        from PySide.QtOpenGL import QGLWidget
    from PySide.QtCore import QEvent, QObject, QSize, Qt, QTimer  # noqa: F401
...
class QVTKRenderWindowInteractor(QVTKRWIBaseClass):
    ...
    GetRenderWindow() to get the vtkRenderWindow.  Create with the keyword
    stereo=1 in order to generate a stereo-capable window.
